...
/*
  Load the plugin
 */
CakePlugin::load('CodeGenerator', array('bootstrap' => true, 'routes' => true));
...
CakePlugin::load('SecretAccess', array('bootstrap' => false, 'routes' => true));
...
Configure::write('USER_EXCLUDE_PARENT_CONTROLLER', array(
  ...
  'plugin' => array(
    ...
    'SecretAccess' => array(
      'SecretAccessController' => 1
    ),
  )
));

Configure::write('USER_EXCLUDE_URL', array(
//  '/shopping-cart/paypalHandle',
//  '/'
));
...
Configure::write('FILE_PLUGIN_CONFIG', array(
  ...
  'files' => array(
    'extensions' => array('png', 'jpg', 'gif', 'jpeg' , 'pdf', 'mp4'),
