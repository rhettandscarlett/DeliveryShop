...
<table class="table" id="file-manager-listing">
  <tr>
    ...
    <th>
      <?php echo $this->Html->link( __('File Name'), '/file/manage?order_by=filename',
        array(
    ...
    <th>
      <?php echo $this->Html->link(__('File Name'), '/file/manage?order_by=name', array('class' => 'file-sort-value', 'data-field' => 'name')); ?>
  ...
  <?php if (empty($files)): ?>
    <tr><td colspan="8"> <?= __("No files") ?></td></tr>
  <?php endif; ?>
