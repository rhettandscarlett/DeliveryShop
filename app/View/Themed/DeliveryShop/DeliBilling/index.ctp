...
<div class="page-body">
  <div class="row">
    <div class="col-md-12">
      <?php foreach ($allBillingList as $scheduleId => $dataList): ?>
      <div class="block block-black">
        <div class="block-title">
          <h3><i
              class="fa fa-bars"></i> <?php echo $scheduleList[$scheduleId] ?>
          </h3>
        ...
        <div class="block-body">
          <div class='table-responsive'>
            <table cellpadding='0' cellspacing='0' class='table'>
              <thead>
              <tr>
                <th width="30%"><?php echo __('Procedure') ?></th>
                <th width="20%"><?php echo __('Bill Code') ?></th>
