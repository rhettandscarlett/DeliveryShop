<?php
echo $this->Form->create('DeliBillingRuntimeProcedure', array(
  'novalidate' => true,
  'inputDefaults' => array(
    'div' => 'form-group',
    'label' => array(
    ...
    <div class="row">
      <div class="col-md-9">
        <h1><i class="fa fa-bars"></i>
          <?php if (isset($this->data['DeliBillingRuntimeProcedure']['id']) && $this->data['DeliBillingRuntimeProcedure']['id'] > 0): ?>
            <?php echo __('Edit') ?>: <?= $this->data['DeliBillingRuntimeProcedure']['name'] ?>
          <?php else: ?>
            <?php echo __('Add') ?>
          <?php endif; ?>
        </h1>
