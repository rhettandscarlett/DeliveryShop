...
(function () {
  CKEDITOR.dialog.add('link', function (editor) {
    ...
    // Handles the event when the "Page" selection box is changed.
    var wsPageChanged = function () {

    };

    var wsLoadPages = function () {
      return [
        ['test 1', 'test 1'],
        ['test 2', 'test 2'],
        ['test 3', 'test 3']
              ...
              children: [
                {
                  id: 'pageOptions',
                  type: 'select',
                  label: sf.language.pages,
//              'default': '',
                  items: sf.ws_pages,
                  onChange: function () {
                    var urlCmb = this.getDialog().getContentElement('info', 'url'),
                      pageUrl = this.getValue();

                    if (pageUrl.length > 0) {
                      urlCmb.setValue(pageUrl);
                    }
                  },
                  setup: function (data) {
//                alert(sf.basePath);
